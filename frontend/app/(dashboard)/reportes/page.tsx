...
export default function ReportesPage() {
  ...
  return (
    <section className="space-y-4">
      <header className="flex flex-wrap items-end justify-between gap-3 border-b border-stone-800/10 pb-4">
        <div><p className="text-xs font-semibold uppercase tracking-[0.22em] text-stone-500">
          Reportes
        </p>
        <h1 className="mt-2 text-2xl font-semibold text-stone-950">Control operativo</h1>
        </div>
